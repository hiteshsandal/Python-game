# do this by creating two program, cave_initialise.py should create the two
...
# two changes to the actual code - remember that shelf jets MUST be strings!

# just to be clear, cave_game.py will contain the code from line 45, everything
# befire that(modified to use shelves) will be in cave_initialise.py
